          ...
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <div className="w-full h-full flex flex-col justify-center items-center bg-[#0B1220] rounded-3xl boreder-3">
                <div className="w-full h-full flex flex-row justify-between items-center border-b-1 border-white rounded-md py-6">
                  <div className="px-8 py-6.5 bg-white/80 border-3 border-green-300 rounded-full flex flex-row justify-center items-center ml-5">
                    O
                  </div>
                  <input
                    type="text"
                    className="px-22 py-1.5 mr-5 bg-green-50 border-3 border-green-300 rounded-md flex flex-row justiy-center items-center"
                  />
                </div>
                ...
                <div className="w-full h-full flex flex-row justify-evenly items-center border-t-1 border-white rounded-md py-6">
                  <button className="px-55 py-1.5 flex flex-row justify-center items-center bg-green-500 rounded-md">
                    Add
                  </button>
                </div>
              </div>
